...
5) Explain the difference between any, unknown, and never types in TypeScript.
...
7) What is the use of enums in TypeScript? Provide an example of a numeric and string enum.
...
9) Provide an example of using union and intersection types in TypeScript.
